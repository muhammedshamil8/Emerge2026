              ...
              <tbody>
                {registrationData.map((row, index) => (
                  <tr key={index} className="text-center ">
                    <td className="border border-black px-1 sm:px-4 py-2 ">
                      {row.category}
                    </td>
          ...
          <div className="flex flex-col gap-3 p-4 mx-auto ">
            <ul className="text-left list-disc list-outside pl-6 ">
              ...
              <li>
                ...
                journals will be communicated after acceptance.
              </li>
              <li>
                Accommodation can be arranged for delegates on a prior request
